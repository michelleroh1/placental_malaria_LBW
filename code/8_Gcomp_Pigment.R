...
##	8_G-computation to estimate effects of mild, moderate, and severe pigmentation
##    on birth outcomes
##
##  This script:
##    1. Fits logistic regression models for each outcome
##    2. Performs parametric g-computation for pigment categories
...
#   Export results 
# ----------------------------
write.xlsx(finalresults, file="Results/DPSP_Pigment_Gcomp_Boot.xlsx")
